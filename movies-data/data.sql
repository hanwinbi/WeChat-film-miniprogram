...
CREATE TABLE `comments`(
  ...
  `movieid` int(11) NOT NULL,
  `moviename` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
SET @IMAGE_BASE_URL = "https://film-1257225145.cos.ap-shanghai.myqcloud.com/"; -- FOR EXAMPLE: https://*****.ap-shanghai.myqcloud.com/
...
INSERT INTO `comments` (`id`,`userid`,`username`,`avatar`,`movieid`,`moviename`,`poster`,`commenttype`,`comment`) VALUES (1,'test','测试用户',CONCAT(@IMAGE_BASE_URL, 'p2504277551.jpg'),1,'复仇者联盟3:无限战争',CONCAT(@IMAGE_BASE_URL, 'p2517753454.jpg'),0,'这是一条测试用的影评信息，我不知道这样的长度够不够长，所以假装多写了几句，以保证他的长度足够的长，以满足测试的需求，到目前为止我也不知道写了多少字，但是看了一下大概只有两行多一点，所以还准备废话一下，试一下看能不能说到三行句，以保证他的长度足够的长，以满足测试的需求，到目前为止我也不知道写了多少字，但是看了一下大概只有两行多一点，所以还准备废话一下，试一下看能不能说到三行');

INSERT INTO `favorite` (`id`,`user`,`movieid`,`commentuserid`) VALUES (0,'obPzD5M_s0TRDtfUYCbXtdSBbIp4',1,'test');